...
public class BoardListAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response)
		...
		int page = 1;
		int limit = 10;// 한페이지ㅔㅇ 보여줄 게시판 목록의수
		...
		return forward;
			...
			//위에서 request를 담았던 것을JsonObject에 담습니다.
			...
			//JsonObject List 형섹을 담을수 있는  addProperty() 존재하지 않습니다.
			//void com.google.gson.JsonObject.add(String property, jsonElement value)
			//메서드를 통해서 저장합니다.
			//List형식을 JsonElement로 바꾸어주어야 object에 저장할 수있습니다.
			//List => JsonElement
